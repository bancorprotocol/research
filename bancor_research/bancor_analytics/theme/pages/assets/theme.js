...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bancor_research/bancor_analytics/theme/pages/assets/aos'), require('jquery'), require('jquery-countdown'), require('bancor_research/bancor_analytics/theme/pages/assets/scrollMonitor'), require('flickity'), require('ion-rangeslider'), require('isotope-layout'), require('jarallax'), require('plyr'), require('prismjs'), require('smooth-scroll'), require('twitter-fetcher'), require('typed.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'bancor_research/bancor_analytics/theme/pages/assets/aos', 'jquery', 'jquery-countdown', 'scrollmonitor', 'flickity', 'ion-rangeslider', 'isotope-layout', 'jarallax', 'plyr', 'prismjs', 'smooth-scroll', 'twitter-fetcher', 'typed.js'], factory) :
